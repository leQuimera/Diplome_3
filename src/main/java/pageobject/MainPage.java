...
public class MainPage {
    ...
    public void clickToTab(String nameOfTab) {
        tabsOfIngredients.findBy(Condition.text(nameOfTab)).shouldBe(Condition.visible).click();
    }
    ...
    public LoginPage clickOnAccountButton() {
        linkToAccountInHeader.shouldBe(Condition.visible).click();
    ...
    public void clickOnBunTab() {
        tabBun.shouldBe(Condition.visible).click();
    }
    ...
    public void clickOnSauceTab() {
        tabSauce.shouldBe(Condition.visible).click();
    }
    ...
    public MainPage clickOnMainTab() {
        tabMain.shouldBe(Condition.visible).click();
        return this;
    }
